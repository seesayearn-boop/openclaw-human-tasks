...
Get your API key:
1. Start a chat with [@LoopumanBot](https://t.me/LoopumanBot) on Telegram
2. Send `/start` to create your account
3. Send `/apikey` to generate your API key
4. You'll receive 100 VAE free credits (100 VAE = $1 USD)
